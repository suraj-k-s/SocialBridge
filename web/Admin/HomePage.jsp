                                            ...
                                            <div class="quick_activity_wrap">
                                                ...
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        <h3><span class="counter">
                                                                <%                                                                String tsel = "select count(*) as c from tbl_influencer";
                                                ...
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        <h3><span class="counter"> 
                                                                <%
                                                                    String ssel = "select count(*) as c from tbl_sponser";
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <%
                                        String tQry = "select * from tbl_influencer ORDER BY RAND()";
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="<%=trs.getString("influencer_photo")%>" alt="">
                                        </div>
                                        <h4><%=trs.getString("influencer_name")%></h4>
                                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <%
                                        String sQry = "select * from tbl_sponser ORDER BY RAND()";
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="<%=srs.getString("sponser_photo")%>" alt="">
                                        </div>
                                        <h4><%=srs.getString("sponser_name")%></h4>
                                    </div>
