...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">influencer Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_influencer t inner join tbl_place p on p.place_id=t.place_id inner join tbl_district dis on dis.district_id=p.district_id";
