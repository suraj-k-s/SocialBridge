...
<html>
    ...
    <%        if (request.getParameter("btn_save") != null) {
            ...
            response.sendRedirect("ViewSponsorComplaint.jsp");
        }
                            ...
                            <div class="QA_section">
                                    ...
                                    <table class="table lms_table_active">
                                        <thead>
                                            <tr style="background-color: #74CBF9">
                                                ...
                                                <td align="center" scope="col">sponser</td>
                                                <td align="center" scope="col">Action</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_complaint c inner join tbl_sponser co on co.sponser_id=c.sponser_id where complaint_status='0'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs.getString("sponser_name")%></td>
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int j = 0;
                                                String selQry1 = "select * from tbl_complaint c inner join tbl_sponser co on co.sponser_id=c.sponser_id where complaint_status='1'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs1.getString("sponser_name")%></td>
