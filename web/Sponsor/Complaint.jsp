...
<html>
    ...
    <%        if (request.getParameter("btn_send") != null) {
            ...
            String insQry = "insert into tbl_complaint(complaint_content,complaint_date,sponser_id)"
...
<%
    ...
    String a = "0",b="0";
    String one ="select count(complaint_status) as one from tbl_complaint where sponser_id='" + session.getAttribute("sid") + "' and complaint_status='0'";
    ResultSet ro = con.selectCommand(one);
    if(ro.next())
    {
        a = ro.getString("one");
    }
    String two ="select count(complaint_status) as two from tbl_complaint where sponser_id='" + session.getAttribute("sid") + "' and complaint_status='1'";
...
%>
            ...
            <table>
                ...
                <%           String selQry = "select * from tbl_complaint where sponser_id='" + session.getAttribute("sid") + "' and complaint_status='0'";
                    int i = 0;
                ...
                if(!b.equals("0"))
{
            ...
            <%                    String selQry1 = "select * from tbl_complaint where sponser_id='" + session.getAttribute("sid") + "' and complaint_status='1'";
