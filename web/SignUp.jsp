...
<html lang="en">
    ...
    <%
        ...
        if (request.getParameter("btn_save") != null) {
            String insQry = "";
            if (request.getParameter("txt_type").equals("Sponsor")) {
                insQry = "insert into tbl_sponser(sponser_name,sponser_contact,sponser_email,sponser_address,sponser_photo,sponser_password,place_id)";
            } else {
                insQry = "insert into tbl_influencer(influencer_name,influencer_contact,influencer_email,influencer_address,influencer_photo,influencer_password,place_id)";
            }
            insQry += "values('" + request.getParameter("txt_name") + "','" + request.getParameter("txt_number") + "','" + request.getParameter("txt_email") + "',"
            ...
            <div class="outer-panel">
                <div class="outer-panel-inner">
                    <div class="process-title">
                        <h2 id="step-title-1" class="step-title is-active" style="margin-top: 25px">Welcome to Social-Bridge.</h2>
                    ...
                    <form method="post">
                        ...
                        <div id="signup-panel-1" class="process-panel-wrap is-active" style="margin-top: 80px">
                            <div class="columns mt-4">
                                <div class="column is-6">
                                    <div class="account-type">
                                        ...
                                        <a class="button is-fullwidth process-button" data-step="step-dot-2" onclick="document.getElementById('txt_type').value = 'Sponsor'">
                                            Continue
                                        </a>
                                    </div>
                                </div>
                                <div class="column is-6">
                                    <div class="account-type">
                                        ...
                                        <a class="button is-fullwidth process-button" data-step="step-dot-2" onclick="document.getElementById('txt_type').value = 'Influencer'">
                                            Continue
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div id="signup-panel-2" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <div class="field">
                                    <label>Name</label>
                                    <div class="control">
                                        <input type="text" required="" class="input" id="txt_name" name="txt_name" placeholder="Enter  name">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Contact</label>
                                    <div class="control">
                                        <input  required="" type="tel" pattern="^\d{10}$" id="txt_number" name="txt_number" class="input" placeholder="Enter  contact">
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <label>Address</label>
                                    <div class="control">
                                        <textarea class="input" required="" id="txt_address" name="txt_address" placeholder="Enter  address" style="border: none;background: transparent"></textarea>
                                    </div>
                                </div>
                                <div class="field">
                        ...
                        <div id="signup-panel-4" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <div class="field">
                                    <label>Email</label>
                                    <div class="control">
                                        <input required="" type="email"  id="txt_email" name="txt_email" class="input" placeholder="Enter  email address">
                                    </div>
                                </div>
                                <div class="field">
